...
if 'page' not in st.session_state:
    st.session_state['page'] = 'config'  # Default to configuration page
...
def show_config_page():
    ...
    # Navigation button to matrix visualization
    st.markdown("---")
    if st.button('Check Matrix Visualization', type='primary'):
        go_to_matrix()
        st.rerun()

# Matrix Visualization Page
def show_matrix_page():
    ...
    if general_checks:
        ...
        st.write("No general checks information available.")
    ...
    # Navigation button back to configuration
    st.markdown("---")
    if st.button('Return to configuration selection', type='primary'):
        go_to_config()
        st.rerun()
